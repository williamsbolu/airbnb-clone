...
const RentModal = () => {
  ...
  // We dynamically import the map, and render it based on the location here every time it changes, so it can work well
  const Map = useMemo(
    () =>
      dynamic(() => import("../Map"), {
        ssr: false,
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="How would you charge per night?"
        />
        <Input
          id="price"
          label="Price"
